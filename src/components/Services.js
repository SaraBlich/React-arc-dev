...
export default function Services(props)
{
    ...
    return(
        <Grid container direction = "column">
            <Grid item style = {{marginLeft: matchesSM ? 0 : "5em", marginTop: matchesSM ? "1em" : "5em" }}>
                <Typography 
                variant = "h2" 
                gutterBottom 
            ...
            <Grid item>
                ...
                style = {{marginTop: matchesSM? "1em" : "5em"}}>
                    <Grid item 
                    style = {{marginLeft: matchesSM ? 0 : "5em", textAlign: matchesSM ? "center" : undefined, width: matchesSM ? undefined : "35em" }}>
